...
class AggressiveStrategy(GameStrategy):
    """Strategy that plays as many cards as possible and maximizes damage."""
    DEFAULT_MANA = 10

    def execute_turn(self, hand: List[Card], battlefield: List[
                        Card]) -> Dict[str, Any]:
        """Execute an aggressive turn using available mana."""
    ...
    def prioritize_targets(self, available_targets: List[Card]) -> List[Card]:
        """Prioritize targets by lowest health first."""
